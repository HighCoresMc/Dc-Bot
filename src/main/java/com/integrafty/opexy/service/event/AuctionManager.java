...
public class AuctionManager extends ListenerAdapter {
    ...
    private void processBid(net.dv8tion.jda.api.interactions.callbacks.IReplyCallback event, long userId, long bidAmount) {
        ...
        net.dv8tion.jda.api.utils.messages.MessageEditBuilder reply = EmbedUtil.createBrandedEditMessage(com.integrafty.opexy.utils.EmbedUtil.containerBranded("AUCTION", "🏆 المزاد الأعمى — Blind Auction", body, com.integrafty.opexy.utils.EmbedUtil.BANNER_MAIN,
    ...
    private void finishAuction(net.dv8tion.jda.api.entities.channel.middleman.MessageChannel channel) {
        ...
        try {
            ...
            channel.sendMessage(EmbedUtil.createBrandedMessage(com.integrafty.opexy.utils.EmbedUtil.containerBranded("AUCTION", "🏁 انتهى المزاد!", body, com.integrafty.opexy.utils.EmbedUtil.BANNER_MAIN))
