...
public class ScavengerHuntManager extends ListenerAdapter {
    ...
    public String startHunt(long rewardAmount, net.dv8tion.jda.api.entities.Guild guild, net.dv8tion.jda.api.entities.Member organizer, net.dv8tion.jda.api.entities.channel.concrete.TextChannel channel) {
        ...
        MessageCreateAction action = this.codeChannel.sendMessage(EmbedUtil.createBrandedMessage(com.integrafty.opexy.utils.EmbedUtil.containerBranded("DISCOVERY", "🔍 لقد وجدت شيئاً!",
    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        if (content.equals(activeCode)) {
            ...
            event.getMessage().reply(EmbedUtil.createBrandedMessage(com.integrafty.opexy.utils.EmbedUtil.containerBranded("WINNER", "🏆 فائز بفعالية الصيد!", 
